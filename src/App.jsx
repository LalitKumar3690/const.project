...
import construction from './components/Videos/Dubai.mp4';
      ...
      <div>
        ...
        <div>
          ...
          <div className="min-h-screen w-full px-4 sm:px-10 md:px-20 bg-gray-100 items-center flex flex-col justify-center">
            <h1 className="text-center text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
              All Cards
            </h1>
          ...
          {/* section7 */}
          <h1 className="text-3xl md:text-5xl bg-black opacity-50 text-white  font-bold text-center py-7">
            Contact Us
          </h1>
